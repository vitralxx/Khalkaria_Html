...
- **Derivados:** Movimento, Evasão, CD. Evasão Passiva = 10 + Mod.DES, igual nas 7 classes; Evasão Ativa = Passiva + **dado de Defender** (1d6…2d8, sem atributo), com a reação, só contra quem te atacou, no turno dele. Defender não tem atributo: o "(Des/Con)" da ficha A4 é resíduo.
- **Condições:** Lento X é intensidade (−3 m e −1 Ação por ponto). Condições mentais = Enfeitiçado, Amedrontado, Confuso, Atordoado (rara *Santuário Intocável*).
