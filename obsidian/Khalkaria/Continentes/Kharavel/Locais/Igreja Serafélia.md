...
era: sessao0
continente: Kharavel
aliases: ["Igreja Serafélia em Construção", "a catedral de Khaskavel"]
...
**Resumo.** Uma catedral gótica em obras no sudoeste de [[Khaskavel]], fora da muralha de [[Vistaluz]]. Aparece nas cartas da cidade de vinte e sete anos atrás com o nome inteiro — **Igreja Serafélia em Construção** — e em nenhum outro lugar: é a única evidência de que "Serafélia" nomeia também uma fé, e não apenas a [[Vanguarda Serafélia]] que guarda a cidade.
...
- Notion — *A Vanguarda Seratélia* `33e6e3a401d98104845ddaafa86b57b2` · *Vistaluz* `33e6e3a401d98192ba6deb2cbe5bcc42` (para o nome, não para a igreja)
- Mestre, 2026-09-05 — C2 (grafia oficial Serafélia) · pergunta E4, sem resposta
- Relatório de fidelidade 2026-09-05 (E4)
