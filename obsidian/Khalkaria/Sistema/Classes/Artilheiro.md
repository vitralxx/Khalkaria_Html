...
**Resumo.** Classe de combate à distância, dano pesado e controle de terreno (🏹). Recurso de classe = **Concentração**, com teto `3 + Mod. Sabedoria`, ganha ao mirar, acertar e ficar parado, e perdida ao receber dano, se mover, falhar em resistência ou ver um aliado cair. **A Concentração soma direto na rolagem de ataque** — é o único recurso do sistema que funciona como bônus de acerto contínuo. Empata com o [[Batedor]] na maior progressão de Stamina (`+7/nível`). **Perfil:** Combate ★★★★☆ · Controle ★★☆☆☆ · Exploração ★★☆☆☆ · Místico ★☆☆☆☆ · Tecnologia ★★★☆☆.
...
A classe vive da economia de munição descrita em [[Armas e Munição]]: uma unidade cobre o combate inteiro, e sem munição nenhuma arma à distância pode ser usada durante todo aquele combate. O "gasta 1 munição" que aparece no custo de *Tempestade de Aço* é essa unidade única.
...
**O teto é apertado de propósito.** Com Sabedoria entre 8 e 13 — modificador de −1 a +1 — o máximo fica entre 2 e 4, e nenhuma das técnicas de custo 5 (*Foco Absoluto*, *Tiro de Reflexo*, *Execução*) nem qualquer das três ultimates chega a ser utilizável; a Marca *Paciência Inabalável*, que pede "6+ Concentração", também fica fora de alcance. O topo da classe só se abre com Sabedoria 14 ou mais. Esse é o preço de entrada do Artilheiro, não um descuido de balanceamento.
...
- **Execução** (1 Ação, 4 Stamina, 5 Concentração) — Seu próximo ataque à distância: Recebe +4 Atacar. **O alvo recebe 2d6 de dano perfurante se estiver com menos de 50% de Saúde.** Adicionalmente, o ataque é crítico se o alvo estiver com menos de 25% de Saúde. Se esse ataque matar o alvo, você ganha +3 Concentração.
...
O dano **Perfurante** que domina o arsenal da classe é subtipo do Ordinário, e o **Fogo** das flechas incendiárias é Elemental ([[Tipos de Dano]]).

## Relações
- **Pertence a** → [[Sistema]] · [[Progressão]] · [[Criação de Personagem]]
- **Recurso de classe** → Concentração (teto `3 + Mod.SAB`; soma direto na rolagem de ataque)
- **Recursos gerais** → Saúde · Stamina, +7/nível, empatada com o [[Batedor]] · [[Éter]], cobrado em 1d6 pelas três ultimates
- **Ramos** → Vendaval (adagas de arremesso/agilidade) · Pólvora (armas de fogo/dano) · Predador (flechas/furtividade)
- **Perícias iniciais** → Armas à Distância, [[Atributos e Perícias|Atacar]], [[Atributos e Perícias|Percepção]]; escolhe entre [[Atributos e Perícias|Furtividade]], [[Atributos e Perícias|Iniciativa]], [[Atributos e Perícias|Ofício]](Engenharia), [[Atributos e Perícias|Investigação]], [[Atributos e Perícias|Movimento]]
- **Regras tocadas** → [[Armas e Munição]] (uma munição por combate) · [[Inventário e Peso]] (munições em bugigangas) · [[Superfícies e Furtividade]] · [[Dano, Ataque e Defesa]] · [[Tipos de Dano]] · [[Descanso]] (fabricação de munição)
- **Itens de classe** → Conjunto de Arremesso · Munição de Fogo · Munição Especial · Flechas e Virotes Perfurante, Farpada, Explosão e Incendiária — comprados e fabricados em [[O Bazar]]
- **Tecnologia no mundo** → *"Armas de fogo acabaram de emergir como tecnologia de ponta"*, o que amarra a classe à engenharia dos anões **Caxon** ([[Anão]]) e ao [[Império de Ferro]]
