...
spoiler: publico
era: atemporal
aliases: [Superfícies, Terreno Difícil, Furtividade, Fuga, Perseguição, Esconder-se]
fonte_notion: 2b76e3a401d980c0ab7bc27a342f4ee1
ultima_sync: 2026-09-05
tags: [khalkaria/sistema, khalkaria/sistema/regras]
---

# Superfícies e Furtividade

**Resumo.** O terreno tem regra: cinco superfícies alteram movimento, teste e vulnerabilidade. **Furtividade** custa 3 ações e é disputa contínua contra Percepção — atacar escondido trata o alvo como *Desprevenido*, e o ataque revela você. Fugir do combate abre uma cena de **Perseguição**: testes de Movimento CD 15 até 3 sucessos (escapa) ou 3 fracassos (é alcançado).
...
> Se a criatura está ciente da sua presença ou ativamente te procurando, você não pode se esconder enquanto estiver em seu campo de visão. Caso não esteja, você disputa *Furtividade* X *Percepção*.
...
- **B16** — "*Reflexo*" na tabela de superfícies é a perícia **Reflexos**.
- **B1** — "Elemental(Eletricidade)" é o tipo **Elétrico** da categoria **Elementais** ([[Tipos de Dano]]).

## Relações
- **Faz parte de** → [[Sistema]]
- **Usa** → [[Atributos e Perícias]] (Furtividade, Percepção, Movimento, Reflexos, Fortitude)
- **Aplica** → [[Condições]] (*Caído*, *Em Chamas*, *Desprevenido*)
- **Encerra cenas de** → [[Combate]]
...
- **"Vulnerável" não é condição formalizada** em [[Condições]] — a superfície Molhado a aplica sem definição própria (a regra de vulnerabilidade está em [[Dano, Ataque e Defesa]]: dano dobrado).
- **"Escondido" não é condição formalizada**, embora seja estado com efeitos mecânicos (aplica *Desprevenido* ao alvo).

## Fonte
Notion `2b76e3a401d980c0ab7bc27a342f4ee1` (Superfícies; Furtividade; Fuga; Perseguição). Raw: `docs/memoria/notion_raw/sistema_root.md`. Digest: `A_sistema.md` §1.17, §4.13.
