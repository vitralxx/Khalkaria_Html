# Magias de Nível 1 — Khalkaria

**20 truques · 5 por escola.** Custo base **0 Éter**. Nível 1 **não tem Intensidade Contida**.
...
> As barras nas descrições indicam valores em ordem: **Normal / Forçada / Transbordante** — três valores, não quatro.

> Modulações mantêm o preço cheio em Nível 1 (D69).
...
`Modulações aplicáveis: Fragmentar (+3) · Alterar (+3) · Carregar (+3) · Marcar (+5)`
...
`Modulações aplicáveis: Fragmentar (+3) · Alterar (+3)`
...
| Ação | 2 Ações | ❎ |
| Alcance | Pessoal | ❎ |
| Área | Cone de 3 / 4,5 / 6 m | ✅ |
| Dano | 1d4 / 2d4 / 3d4 Ordinário (perfurante) | ✅ |
| Resistência | Reflexos para metade · CD +0 / +2 / +4 | ✅ |

Você materializa um punhado de cacos místicos e os cospe em cone.

`Modulações aplicáveis: Alterar (+3) · Carregar (+3)`
...
| Alcance | 3 / 4,5 / 6 m | ✅ |
| Presas | 2 / 3 / 4 | ✅ |
| Alvo | 1 criatura por presa, à sua escolha | ❎ |
| Dano | 1d4 Frio por presa | ❎ |
...
`Modulações aplicáveis: Ancorar (+2) · Refletir (+3) · Socializar (+4) · Acelerar (+5)`
...
|---|---|---|
| Ação | Ação Livre | ❎ |
| Alcance | Pessoal (apenas em você) | ❎ |
...
`Modulações aplicáveis: Ancorar (+2)`
...
| Ação | 1 Ação | ❎ |
| Alcance | 3 / 4,5 / 6 m | ✅ |
| Área | Painel de 1,5 m × 1,5 m | ❎ |
| Saúde do Painel | 5 / 10 / 15 | ✅ |
...
`Modulações aplicáveis: Socializar (+4) · Acelerar (+5)`
...
| Ação | 1 Ação | ❎ |
| Alcance | Toque | ❎ |
| Alvo | 1 / 2 / 3 Criatura(s) voluntária(s) | ✅ |
| Duração | Até o fim do seu próximo turno | ❎ |
...
`Modulações aplicáveis: Alcançar (+3) · Contagiar (+3)`
...
`Modulações aplicáveis: Inversão (+2) · Contagiar (+3) · Insistir (+5)`
...
| Alvo | 1 Criatura | ❎ |
| Duração | 1 Rodada | ❎ |
| Resistência | Vontade ou Lento 1 · CD +0 / +2 / +4 | ✅ |
...
`Modulações aplicáveis: Inversão (+2) · Alcançar (+3) · Contagiar (+3) · Insistir (+5)`
...
|---|---|---|
| Ação | 1 Ação | ❎ |
| Alcance | Pessoal · raio 4,5 / 9 / 13,5 m | ✅ |
...
`Modulações aplicáveis: Compartilhar (+1) · Exigir (+2) · Projetar (+2)`
...
`Modulações aplicáveis: Compartilhar (+1) · Exigir (+2) · Projetar (+2) · Gravar (+3)`
...
|---|---|---|
| Ação | 1 Ação | ❎ |
| Alcance | 9 / 18 / 27 m para marcar | ✅ |
| Alvo | 1 Criatura que você possa ver | ❎ |
| Duração | 10 minutos / 1 hora / 8 horas | ✅ |
...
|---|---|---|
| Ação | Reação | ❎ |
| Gatilho | Você tira 1 na rolagem de um teste de perícia | ❎ |
| Alcance | Pessoal | ❎ |
...
`Modulações aplicáveis: Compartilhar (+1) · Exigir (+2) · Gravar (+3)`
